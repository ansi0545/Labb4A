...
<body>
  <div class="container">
    <header class="header">
      <div class="logo">
        <img src="logo.png" height="68" width="68" alt="Faktabloggen Logo" />
        <h1>Vovvebloggen</h1>
      </div>

      <button class="btn btn-large btn-open">Dela fakta</button>
    </header>

    <form class="fact-form hidden">
      <input type="text" placeholder="Dela intressanta fakta..." />
      <span>200</span>
      <input type="text" placeholder="Trovärdig källa..." />
      <select>
        <option value="">Välj kategori:</option>
        <option value="technology">Teknik</option>
        <option value="science">Vetenskap</option>
        <option value="society">Samhälle</option>
      ...
      <button class="btn btn-large">Lägg upp</button>
    </form>
    ...
    <main class="main">
      <aside>
        <ul>
          <li class="category">
            <button class="btn btn-all-categories">Alla kategorier</button>
          </li>
          <li class="category">
          ...
          <li class="category">
            <button class="btn btn-category" style="background-color: #eab308">
              Samhälle
            </button>
          </li>
          <li class="category">
            <button class="btn btn-category" style="background-color: #db2777">
              Nöje
            </button>
          </li>
          <li class="category">
            <button class="btn btn-category" style="background-color: #14b8a6">
              Hälsa
            </button>
          </li>
          <li class="category">
            <button class="btn btn-category" style="background-color: #f97316">
              Historia
            </button>
          </li>
          <li class="category">
            <button class="btn btn-category" style="background-color: #ef4444">
              Finans
            </button>
          </li>
          <li class="category">
            <button class="btn btn-category" style="background-color: #8b5cf6">
              Nyheter
            </button>
          </li>
        </ul>
        ...
        <ul class="facts-list">
          ...
          <li class="fact">
            <p>
              ...
              <a class="source" href="https://www.mother.ly/parenting/millennial-dads-spend-more-time-with-their-kids"
